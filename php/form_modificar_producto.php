<?php
    $code_prod = isset($_GET["code_prod"]) ? $_GET["code_prod"] : null;
    $code_inv = isset($_GET["code_inv"]) ? $_GET["code_inv"] : null;
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <div class="form-container">
        ...
        <?php echo "<form action='../php/updateproduct.php?code_prod=".$code_prod."&code_inv=".$code_inv."' method='POST'>";?>
            ...
            <div class="form-group">
                ...
                <input type="file" id="photo" name="PHOTOPROD" accept="image/*">
            </div>
            <div class="form-group">
    ...
    <script>
        ...
        fileInput.addEventListener('change', function() {
            if (fileInput.files.length > 0) {
                ...
                label.textContent = 'Haz clic para cambiar la imagen';
            }
        });
    </script>
</body>
